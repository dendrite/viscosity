...
import ru.ttk.netty.echo.client.KryoClientHandler;
 ...
 *
 */
public class KryoServerPipelineFactory  implements ChannelPipelineFactory {
    ...
    public KryoServerPipelineFactory(String who_is){
        super();
...
//        kryoMessage.setStatus("Going from Client");
       ...
       // pipeline.addLast("decoder", new KryoDecoder(this.kryoValueDeserializer,who_is));
        ...
        pipeline.addLast("handler", new KryoServerHandler(kryoValueSerializer, kryoValueDeserializer));
